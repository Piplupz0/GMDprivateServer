...
$string["welcome"] = "Willkommen bei ".$gdps.'!';
$string["didntInstall"] = "<div style='color:#47a0ff'><b>Warnung!</b> Sie haben das Dashboard noch nicht vollständig installiert! Klicken Sie dazu auf das Wort.</div>";
$string["levelsWeek"] = "In einer Woche hochgeladene Level";
$string["levels3Months"] = "In 3 Monaten hochgeladene Level";
$string["footer"] = $gdps.", ".date('Y', time());
$string["tipsAfterInstalling"] = "Willkommen im Dashboard! Wir geben Ihnen nach der Installation einige tipps:<br>
1. Es scheint, dass in der tabelle 'roles' in SQL neue berechtigungen aufgetaucht sind! Du solltest es dir ansehen...<br>
